  ...
  presentation: {
    ...
    setup: {
      ...
      fields: [
        ...
        { key: "channels.email.oauthTenantId", section: "credentials" },
        { key: "channels.email.oauthClientId", section: "credentials" },
        { key: "channels.email.oauthClientSecret", section: "credentials" },
